...
*/
kangaroo = createSprite(200,340,20,20);
kangaroo.addAnimation("kangarroo",kangaroo_running);
kangaroo.addAnimation("collided",kangaroo_collided);
kangaroo.scale=0.14
kangaroo.setCollider("circle",10,-100,500)


//Create a sprite for Invisible ground and place it at the bottom side of the screen.
  invisibleGround = createSprite(100,350,1000,10);
